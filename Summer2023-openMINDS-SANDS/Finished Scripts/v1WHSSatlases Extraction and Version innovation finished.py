...
#Define variables required for anchor point extraction:
  ...
  #Do you want to use the anchor point updater aswell? (yes or no)
Anchoranswer = "yes"
  #if the answer is yes add the pathway to the version innovation file
if Anchoranswer == "yes":
  #Write the pathway for the version innovation document
  AnchorpointFile = pd.read_excel(r"C:\Users\mats_\Desktop\Ebrains\WHS v1\WHS_SD_rat_atlas_v1.nii.xlsx")
...
xmlpath = r"C:\Users\mats_\Desktop\Ebrains\WHS v1\WHS_SD_rat_atlas_v1_labels.ilf"
#Add where you want the json files to be located.
JsonLocation = r"C:\Users\mats_\Desktop\Ebrains\Visual Code\openMINDS_SANDS\instances\atlas\parcellationEntityVersion\WHSSDatlas_v1"
...
for i in range(0,100):
  ...
  val = soup.find(id=i) 
  #"Gray Matter had id 2 and as its a parent i cannot include it"
    ...
    if answer == "yes":
      ...
      for Vers in Versions:
        ...
        if findAbbre.empty:
          ...
          NoGoodDescription.append(f"There is something wrong with {Id}, the program is not able to recognize the data on this line")
          break
...
with open(f'ErrorDocument{VersionIdentity}.txt', 'w') as f:
